...
## Introduction
Working in finance and data provides a visual of what people on the outside may not see - the hidden patterns inside the customer numbers. Every transaction, balance, and customer interaction is carefully recorded which builds bit and pieces of the bank's story.

Banks and other financial institutions relies on various simple, yet impactful calculations and reports to understand customers (both active customers and those that have exited). From an analytics prespective, piecing together differnt information about the customers and its data will help management understand their customers and how to improve the bank's performance.

## Background
This project takes a dataset of 10,000 bank customers' financial behavior, demographcis, product engagement, and satisfaction (dataset developed by [Radheshyam Kollipara](https://www.kaggle.com/datasets/radheshyamkollipara/bank-customer-churn)). The goal for this project was to clean and manipulate the bank customer dataset to which then was inputed into a dashboard to provide actionable insight and performance. The findings are presented as more than just charts and metrics, but as actionable insights banak mangagement can see to make more impactful business decisions.

## Tools I Used

* <b> PowerBI </b> - the foundation of my project, used to take the bank data and provided actionable insights through interactive visualizations and reporting.
